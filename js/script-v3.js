...
function handleRadioButtonChange(radioButton) {
  ...
  totalDiscount.textContent = 'UŠTEDA ' + formatPrice((oldPrice - actualPrice));

  // update link for selected package
  if(Number(selectedPackage) === 3) {
    addToCartLink.href = 'https://swisspower.hr/cart/48140184617297:3';
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  } else if (Number(selectedPackage) === 1) {
    addToCartLink.href = 'https://swisspower.hr/cart/48140184617297:1';
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  } else {
    addToCartLink.href = 'swisspower.hr/cart/48140184617297:2' + selectedPackage;
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  }
